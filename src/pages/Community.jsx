  ...
  return (
    ...
    <div class="container mx-auto pt-10">
      <div class="flex justify-center items-between my-5 px-6">
          ...
          onClick={()=>{
            localStorage.setItem('emailProfile','opp@gmail.com');
            localStorage.setItem('profileCommunity',true);
          }}
          >
      ...
      <a href="/Profile" class=" rounded-full flex justify-center  ring-2 ring-black items-center w-44 h-44 mb-3 mr-20 hover:brightness-50"
      onClick={()=>{
        localStorage.setItem('emailProfile','chanon178@hotmail.com');
        localStorage.setItem('profileCommunity',true);
      ...
      <a href="/Profile" class=" rounded-full flex justify-center  ring-2 ring-black items-center w-44 h-44 mb-3 mr-20 hover:brightness-50"
      onClick={()=>{
        localStorage.setItem('emailProfile','user@gmail.com');
        localStorage.setItem('profileCommunity',true);
      }}
      >
      <img src={keyboardlogo} alt="" className="w-40" />
