...
const EProfile = () => {
  ...
  if (localStorage.getItem('profileCommunity'))
  {
    return (
...
const Profile = () => {
  ...
  const email = localStorage.getItem('emailProfile');
  ...
  function getProfile1(){
    axios.post('http://191.96.93.178:5000/userProfile',{
      email: user.email,
    })
    .then((response) =>{
      ...
      <div class="container mx-auto my-auto w-4/6  rounded-3xl pt-6">
        <div class="flex justify-center items-between px-6 mb-5">
          ...
          <div class=" bg-[#334756]  ml-24 w-3/6 rounded-xl">
            ...
            <div class="mt-4 mx-5">
              <h1 class="font-bold text-white text-xl"> {datas.name} </h1>
            ...
            >
              ...
              <div class="carousel-inner relative w-full overflow-hidden">
                ...
                <div class="carousel-item float-left w-full">
                  <img
                    src="https://images.wallpaperscraft.com/image/single/keyboard_key_backlight_128828_2560x1080.jpg"
                    class="block w-full"
                    alt="Camera"
                  />
                </div>
                <div class="carousel-item float-left w-full">
                  <img
                    src="https://images.wallpaperscraft.com/image/single/keyboard_backlight_black_and_white_218666_2560x1080.jpg"
                    class="block w-full"
                    alt="Exotic Fruits"
                  />
                </div>
